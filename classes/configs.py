...
class Configs:
    ...
    def __init__(self, order, is_source_ftp, source_path, is_destination_ftp, destination_path, is_delete, is_dual, ignore_regex_list, rename_dict):
        '''
        Parameters
        ----------
        order : int
    ...
    def from_dict(configs_dict):
        ...
        Configs
        '''
        return Configs(configs_dict['order'], configs_dict['is_source_ftp'], configs_dict['source_path'], configs_dict['is_destination_ftp'], configs_dict['destination_path'], configs_dict['is_delete'], configs_dict['is_dual'], configs_dict['ignore_regex_list'], configs_dict['rename_dict'])
